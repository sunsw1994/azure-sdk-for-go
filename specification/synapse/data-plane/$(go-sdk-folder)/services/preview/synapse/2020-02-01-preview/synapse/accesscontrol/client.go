// Package synapse implements the Azure ARM Synapse service API version 2020-02-01-preview.
//
//
package synapse
...
func NewWithoutDefaults(endpoint string) BaseClient {
    ...
    func (client BaseClient) CreateRoleAssignment(ctx context.Context, createRoleAssignmentOptions RoleAssignmentOptions) (result RoleAssignmentDetails, err error) {
        if tracing.IsEnabled() {
            ...
            return result, validation.NewError("synapse.BaseClient", "CreateRoleAssignment", err.Error())
            }

            req, err := client.CreateRoleAssignmentPreparer(ctx, createRoleAssignmentOptions)
        if err != nil {
        err = autorest.NewErrorWithError(err, "synapse.BaseClient", "CreateRoleAssignment", nil , "Failure preparing request")
        return
        }
            ...
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "CreateRoleAssignment", resp, "Failure sending request")
            return
            }

            result, err = client.CreateRoleAssignmentResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "CreateRoleAssignment", resp, "Failure responding to request")
            }
    ...
    func (client BaseClient) DeleteRoleAssignmentByID(ctx context.Context, roleAssignmentID string) (result autorest.Response, err error) {
        if tracing.IsEnabled() {
            ...
            return result, validation.NewError("synapse.BaseClient", "DeleteRoleAssignmentByID", err.Error())
            }

            req, err := client.DeleteRoleAssignmentByIDPreparer(ctx, roleAssignmentID)
        if err != nil {
        err = autorest.NewErrorWithError(err, "synapse.BaseClient", "DeleteRoleAssignmentByID", nil , "Failure preparing request")
        return
        }
            ...
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "DeleteRoleAssignmentByID", resp, "Failure sending request")
            return
            }

            result, err = client.DeleteRoleAssignmentByIDResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "DeleteRoleAssignmentByID", resp, "Failure responding to request")
            }
    ...
    func (client BaseClient) GetCallerRoleAssignments(ctx context.Context) (result ListString, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetCallerRoleAssignments", nil , "Failure preparing request")
        return
        }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetCallerRoleAssignments", resp, "Failure sending request")
            return
            }

            result, err = client.GetCallerRoleAssignmentsResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetCallerRoleAssignments", resp, "Failure responding to request")
            }
    ...
    func (client BaseClient) GetRoleAssignmentByID(ctx context.Context, roleAssignmentID string) (result RoleAssignmentDetails, err error) {
        if tracing.IsEnabled() {
            ...
            { TargetValue: roleAssignmentID,
             Constraints: []validation.Constraint{	{Target: "roleAssignmentID", Name: validation.MinLength, Rule: 1, Chain: nil }}}}); err != nil {
            return result, validation.NewError("synapse.BaseClient", "GetRoleAssignmentByID", err.Error())
            }

            req, err := client.GetRoleAssignmentByIDPreparer(ctx, roleAssignmentID)
        if err != nil {
        err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleAssignmentByID", nil , "Failure preparing request")
        return
        }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleAssignmentByID", resp, "Failure sending request")
            return
            }

            result, err = client.GetRoleAssignmentByIDResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleAssignmentByID", resp, "Failure responding to request")
            }
    ...
    func (client BaseClient) GetRoleAssignments(ctx context.Context, roleID string, principalID string, continuationToken string) (result ListRoleAssignmentDetails, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleAssignments", nil , "Failure preparing request")
        return
        }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleAssignments", resp, "Failure sending request")
            return
            }

            result, err = client.GetRoleAssignmentsResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleAssignments", resp, "Failure responding to request")
            }
    ...
    // GetRoleDefinitionByID get role by role Id.
        // Parameters:
            // roleID - synapse Built-In Role Id.
    func (client BaseClient) GetRoleDefinitionByID(ctx context.Context, roleID string) (result Role, err error) {
        if tracing.IsEnabled() {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleDefinitionByID", nil , "Failure preparing request")
        return
        }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleDefinitionByID", resp, "Failure sending request")
            return
            }

            result, err = client.GetRoleDefinitionByIDResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleDefinitionByID", resp, "Failure responding to request")
            }
    ...
    autorest.WithQueryParameters(queryParameters))
        ...
        // closes the http.Response Body.
        func (client BaseClient) GetRoleDefinitionByIDResponder(resp *http.Response) (result Role, err error) {
                err = autorest.Respond(
                resp,
                azure.WithErrorUnlessStatusCode(http.StatusOK),
                autorest.ByUnmarshallingJSON(&result),
    ...
    func (client BaseClient) GetRoleDefinitions(ctx context.Context) (result RolesListResponsePage, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleDefinitions", nil , "Failure preparing request")
        return
        }
            ...
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleDefinitions", resp, "Failure sending request")
            return
            }

            result.rlr, err = client.GetRoleDefinitionsResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "synapse.BaseClient", "GetRoleDefinitions", resp, "Failure responding to request")
            }
    ...
    autorest.WithQueryParameters(queryParameters))
        ...
        func (client BaseClient) GetRoleDefinitionsResponder(resp *http.Response) (result RolesListResponse, err error) {
                ...
                if err != nil {
                return result, autorest.NewErrorWithError(err, "synapse.BaseClient", "getRoleDefinitionsNextResults", nil , "Failure preparing next results request")
                }
                if req == nil {
                return
                }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "synapse.BaseClient", "getRoleDefinitionsNextResults", resp, "Failure sending next results request")
                }
                result, err = client.GetRoleDefinitionsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "synapse.BaseClient", "getRoleDefinitionsNextResults", resp, "Failure responding to next results request")
                }
                return
                        }
